...
var t; //trello wrapper

const AWS = require('aws-sdk');
const encrypted = process.env.trello_api_key;
let trello_api_key;
...
function processEvent(event, context, callback) {
    ...
    if (!this.attributes.userToken) {

    }
    try {
        t = new Trello(trello_api_key, this.attributes.userToken);
    } catch (e) {
...
var newCardHandlers = Alexa.CrateStateHandler(states.NEWCARD, {
